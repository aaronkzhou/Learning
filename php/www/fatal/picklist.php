...
from test
where(material_end_time="" and production_start_time="" and preparationend="" and test.remark not like"%cancel%")
';
...
$query4='
select count(test.PLO),sum(Qty)
from test left outer join linetype ON test.PLO=linetype.PLO
...
where
(UpdateTime=""and test.remark not like"%cancel%")
';
...
style="width:40%;margin-left:0px;font-family: sans-serif">
